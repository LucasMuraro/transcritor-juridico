...
export function OutputPreview() {
  return (
    <section className="bg-paper-200 py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="text-center mb-14 lg:mb-16 max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[2.6rem] font-extrabold tracking-tight text-ink-900 mb-4 text-balance">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-5">
            <div className="rounded-2xl bg-ink-900 p-7 text-white shadow-2xl shadow-ink-900/20 ring-1 ring-white/5">
              <div className="flex items-center gap-3 mb-5">
                <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-ink-700">
                  <Volume2 className="h-5 w-5 text-brand" strokeWidth={2.2} />
                </span>
              ...
              <div className="flex items-center justify-between text-[0.74rem] text-ink-400 font-mono">
                <span>00:00:00</span>
                <span>01:24:13</span>
              </div>

              <div className="mt-6 pt-5 border-t border-white/10 flex items-center gap-2 text-[0.85rem] text-brand">
          ...
          <div className="lg:col-span-7">
            <div className="relative rounded-xl bg-white shadow-2xl shadow-ink-900/[0.08] p-7 lg:p-10 ring-1 ring-paper-300/60">
              <div
                aria-hidden
                className="absolute top-0 right-0 h-12 w-12 bg-gradient-to-bl from-paper-200 to-transparent rounded-bl-xl rounded-tr-xl pointer-events-none"
              />

              <div className="flex items-center gap-2 pb-4 border-b border-paper-300/60 mb-5">
                <FileText className="h-4 w-4 text-ink-400" strokeWidth={2.2} />
                <div className="text-[0.7rem] font-mono text-ink-500 tracking-wide uppercase">
                ...
                {LINES.map((line) => (
                  <div key={line.speaker}>
                    <div className="flex items-baseline gap-2">
                      <span className="font-bold text-ink-900 tracking-tight">{line.speaker}</span>
                      <span className="text-[0.72rem] font-mono text-ink-400">({line.ts})</span>
                    </div>
                    <p className="text-ink-700 mt-0.5">&ldquo;{line.text}&rdquo;</p>
                  </div>
                ))}
                <div className="pt-1 text-[0.78rem] text-ink-400 italic">
                  [ continua... ]
                </div>
              </div>

              <div className="mt-6 pt-4 border-t border-paper-300/60 flex items-center justify-between">
                <div className="flex items-center gap-2 text-[0.78rem] text-ink-500">
